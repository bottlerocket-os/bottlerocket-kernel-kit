...
# at boot. Resolved to /usr/nvidia/lts
...
Source800: nvidia-lts-overlay-driver.service
Source801: nvidia-lts-overlay-config.service
...
Conflicts: (%{_cross_os}kmod-6.18-nvidia-fb unless %{_cross_os}kmod-6.18-nvidia-multi)
...
install -p -m 0644 %{S:800} %{buildroot}%{_cross_unitdir}/nvidia-lts-overlay-driver.service
install -p -m 0644 %{S:801} %{buildroot}%{_cross_unitdir}/nvidia-lts-overlay-config.service
