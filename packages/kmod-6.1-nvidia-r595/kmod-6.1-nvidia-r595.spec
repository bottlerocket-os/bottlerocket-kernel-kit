...
Provides: %{_cross_os}kmod-6.1-nvidia-%{nvidia_branch}
...
Provides: %{_cross_os}kmod-6.1-nvidia-%{nvidia_branch}-fabricmanager
...
Requires: %{name}
Provides: %{_cross_os}kmod-6.1-nvidia-%{nvidia_branch}-open-gpu
...
Provides: %{_cross_os}kmod-6.1-nvidia-%{nvidia_branch}-grid
...
Provides: %{_cross_os}kmod-6.1-nvidia-%{nvidia_branch}-tesla
...
Requires: %{name}
Provides: %{_cross_os}kmod-6.1-nvidia-%{nvidia_branch}-mps
...
Version: %{gdrcopy_ver}
License: MIT AND GPL-2.0-only
Provides: %{_cross_os}kmod-6.1-nvidia-%{nvidia_branch}-gdrcopy
Requires: %{_cross_os}variant-platform(aws)
Requires: %{name}
...
# Graphics libs
%{nvidia_libdir}/libnvidia-egl-wayland2.so.1
%{nvidia_libdir}/libnvidia-egl-wayland2.so.1.0.1
