...
# Refuse to co-install the lts and pb branches without the nvidia-dual-branch
# image feature, so a variant that pulls in both fails to resolve.
Conflicts: (%{_cross_os}kmod-6.18-nvidia-lts unless %{_cross_os}image-feature(nvidia-dual-branch))
